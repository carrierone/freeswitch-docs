...
spandsp\_start\_tone\_detect

Start background tone detection with cadence

spandsp\_start_tone_detect \<uuid> \<descriptor name>

spandsp\_stop\_tone\_detect

Stop background tone detection with cadence

spandsp\_stop_tone_detect \<uuid>

#### Events

You will need to connect to the ESL socket in order to pick up tone events from spandsp\_start\_tone\_detect.
...
[http://www.soft-switch.org/t38/index.html](http://www.soft-switch.org/t38/index.html) — Here are some more informations about T.38

[http://www.itu.int/pub/T-SP-OB.781-2003](http://www.itu.int/pub/T-SP-OB.781-2003) — Various Tones Used in National Networks

[https://www.soft-switch.org/spandsp%5Ffaq/ar01s14.html](https://www.soft-switch.org/spandsp%5Ffaq/ar01s14.html) — How to generate a FAX compatible multi-page TIFF
